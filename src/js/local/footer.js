...
<div class="relative bg-gradient-to-br   from-gray-100 to-gray-200 text-gray-900 py-16 px-8 border-t-[1px] border-gray-300">
    ...
    <div class="">
      ...
      <form class="mt-4 flex">
        <input type="email" placeholder="Your email"
          class="w-full px-4 py-2 rounded-l-lg bg-gray-300 text-gray-700 border-none focus:ring-blue-500 outline-none">
        <button class="px-4 py-2 bg-gradient-to-r from-blue-600  to-purple-600  text-white rounded-r-lg hover:bg-blue-600 transition duration-300">
          Subscribe
        </button>
      </form>
    </div>
  ...
  <div class="relative  mt-4 pt-6 text-center ">
    ...
    <div class="flex justify-center space-x-6 mt-4">
      <a href="https://www.facebook.com/anmamun0" target="_blank" class="text-gray-700 hover:text-blue-500 transition duration-300"><i class="fab fa-facebook text-lg"></i></a>
      <a href="https://www.facebook.com/anmamun0" target="_blank" class="text-gray-700 hover:text-blue-500 transition duration-300"><i class="fab fa-twitter text-lg"></i></a>
      <a href="https://anmamun0.vercel.app/" target="_blank" class="text-gray-700 hover:text-blue-500 transition duration-300"><i class="fab fa-instagram text-lg"></i></a>
      <a href="https://www.facebook.com/anmamun0" target="_blank" class="text-gray-700 hover:text-blue-500 transition duration-300"><i class="fab fa-linkedin text-lg"></i></a>
    </div>
  </div>
</div>
